...
func (r *outboxGormRepository) MarkPublished(ctx context.Context, id string) error {
	...
	return r.db.WithContext(ctx).
		...
		Updates(map[string]any{"status": entity.OutboxStatusPublished, "published_at": now}).Error
}
...
// NewOutboxDispatchAdapter wraps the delivery outbox repo for use by pkg/outbox.Dispatcher.
