...
// OutboxEvent implements the transactional outbox pattern — payment publishes
// payment/wallet/payout events via this table so Kafka delivery is atomic with DB writes.
