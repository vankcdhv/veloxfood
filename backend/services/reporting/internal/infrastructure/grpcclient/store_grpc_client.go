...
// StoreOwnership holds the vendor/owner fields used to authorize a store owner's
// access to that store's reports.
...
// requester owns (manages) the store before exposing its reports.
