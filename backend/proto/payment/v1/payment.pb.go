...
type GetPaymentStatusResponse struct {
	...
	Amount        int64                  `protobuf:"varint,3,opt,name=amount,proto3" json:"amount,omitempty"`              // VND
	PayUrl        string                 `protobuf:"bytes,4,opt,name=pay_url,json=payUrl,proto3" json:"pay_url,omitempty"` // MoMo checkout URL persisted at capture time (empty otherwise)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetPaymentStatusResponse) GetPayUrl() string {
	if x != nil {
		return x.PayUrl
	}
	return ""
...
const file_proto_payment_v1_payment_proto_rawDesc = "" +
	...
	"\apay_url\x18\x04 \x01(\tR\x06payUrl2\xf4\x01\n" +
